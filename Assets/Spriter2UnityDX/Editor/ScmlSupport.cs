...
namespace Spriter2UnityDX.Importing
{
    ...
    { //Master class that holds all the other data
        [XmlElement("folder")]
        public Folder[] folders { get; set; } // <folder> tags
        [XmlElement("entity")]
        public Entity[] entities { get; set; } // <entity> tags  
    }
    ...
    public class Folder : ScmlElement
    {
        ...
        [XmlElement("file")]
        public File[] files { get; set; } // <file> tags
    }
    ...
    public class Entity : ScmlElement
    {
        ...
        public CharacterMap[] characterMaps { get; set; } // <character_map> tags
        [XmlElement("animation")]
        public Animation[] animations { get; set; } // <animation> tags
    }
    ...
    public class CharacterMap : ScmlElement
    {
        ...
        public string name { get; set; }
        [XmlElement("map")]
        public MapInstruction[] maps { get; set; } // <map> tags
    }
    ...
    public class Animation : ScmlElement
    {
        ...
        [XmlAttribute]
        public bool looping { get; set; } // enum : NO_LOOPING,LOOPING //Dengar.NOTE: the actual values are true and false, so it's a bool
        [XmlArray("mainline"), XmlArrayItem("key")]
        public MainLineKey[] mainlineKeys { get; set; } // <key> tags within a single <mainline> tag
        [XmlElement("timeline")]
        public TimeLine[] timelines { get; set; } // <timeline> tags
    }
    ...
    public class MainLineKey : ScmlElement
    {
        ...
        [XmlElement("bone_ref")]
        public Ref[] boneRefs { get; set; } // <bone_ref> tags
        [XmlElement("object_ref")]
        public Ref[] objectRefs { get; set; } // <object_ref> tags      
    }
    ...
    public class Ref : ScmlElement
    {
        public Ref() { parent = -1; }
        [XmlAttribute]
        public int parent { get; set; } // -1==no parent - uses ScmlObject spatialInfo as parentInfo
        [XmlAttribute]
        public int timeline { get; set; } //Dengar.NOTE: Again, the above comment is an artifact from the pseudocode
        [XmlAttribute]
        public int key { get; set; }        //However, the fact that -1 equals "no parent" does come in useful later
        private float z;
        [XmlAttribute]
    ...
    public class TimeLine : ScmlElement
    {
        ...
        public string name { get; set; }
        [XmlAttribute]
        public ObjectType objectType { get; set; } // enum : SPRITE,BONE,BOX,POINT,SOUND,ENTITY,VARIABLE //Dengar.NOTE (except not in all caps)
        [XmlElement("key")]
        public TimeLineKey[] keys { get; set; } // <key> tags within <timeline> tags   
    }
    ...
    public class TimeLineKey : ScmlElement
    {
        ...
        [XmlAttribute]
        public CurveType curve_type { get; set; } // enum : INSTANT,LINEAR,QUADRATIC,CUBIC //Dengar.NOTE (again, no caps)
        [XmlAttribute]
        public float c1 { get; set; }
        [XmlAttribute]
        public float c2 { get; set; } //I think these should be implemented some time in the future
        [XmlAttribute]
